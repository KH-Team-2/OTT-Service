...
<div id="menu">
  <div id="menuBar">
    <table id="menuTable">
      ...
      <tr>
        <td>
          <input type="button" class="menuSelect" id="menu_2" value="시청기록" onclick="$('#iframe_in').attr('src','View_History.jsp')">
        </td>
      </tr>
      <tr>
        <td>
          <input type="button" class="menuSelect" id="menu_3" value="정보수정" onclick="$('#iframe_in').attr('src','Update.jsp')">
        </td>
      </tr>
    </table>
  ...
  <div id="iframe">
    <iframe id="iframe_in" src="WishListViewPage.jsp" width="100%" height="100%" frameborder="0" allowfullscreen></iframe>
  </div>
</div>
</body>
</html>
