...
<head>
    ...
    <script type="text/javascript">
        function UserSecession() {
            var num = confirm("정말 탈퇴하시겠습니까?");
            if (num) {
                location.href = "user.do?command=userSecession&usernum=" +${dto.userNum};
            }
        }
...
<div>
    ...
    <form action="userUpdate.do" method="post" id="updateform">
        ...
        <table>
            <tr>
                <td>ID</td>
                <td><input type="text" value="${dto.ID }" name="id" class="updateval" readonly="readonly"
                           disabled="disabled"><input type="hidden" name="id" value="${dto.ID}"/></td>
            </tr>
            <tr>
                <td>PW</td>
                <%
                ...
                %>
                <td><input type="password" name="pw" value="${dto.PW }" class="updateval" readonly="readonly"
                           disabled="disabled"><input type="hidden" name="pw" value="${dto.PW}"/></td>
                <%
                } else {
                %>
...
<%--                <td><input type="text" name="phone" value="${dto.phone }" class="updateval"></td>--%>
            ...
            <tr>
                <td>성별</td>
                <td><input type="radio" name="gender" value="M" <c:if test="${dto.gender eq 'M'}">checked</c:if>>남
                    <input type="radio" name="gender" value="W" <c:if test="${dto.gender eq 'W'}">checked</c:if>>여
                </td>
            </tr>
            <tr>
                <td>닉네임</td>
